...
LastEditTime: 2026-06-29 14:28:24
'''
...
from dodrio.afeat.feat_extractor import (
    extract_feat, get_utt2spk, extract_feat_multi, extract_feat_align, extract_feat_extrainfo, extract_bert_extrainfo, extract_feat_tpool
)
